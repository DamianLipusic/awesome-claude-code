...
const TUTORIAL_KEY = "empireOS_tutorial_complete";
...
const STEPS: TutorialStep[] = [
  {
    title: "Welcome to EmpireOS!",
    body: "Build your criminal empire from the ground up. Earn money, expand operations, and climb the ranks.",
    icon: "\uD83C\uDFD9\uFE0F",
  },
  {
    title: "Start a Business",
    body: "Create a business to start generating income. Each business produces revenue every 5 minutes automatically.",
    icon: "\uD83C\uDFED",
  },
  {
    title: "Hire Employees",
    body: "Hire employees to boost your productivity and unlock new capabilities. Some roles enable criminal operations.",
    icon: "\uD83D\uDC77",
  },
  {
  ...
  {
    title: "Unlock Crime Operations",
    body: "Take on high-risk crime operations for bigger rewards. Manage your heat level to avoid getting busted.",
    icon: "\uD83D\uDD25",
  },
];
